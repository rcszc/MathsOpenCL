...
protected:
	LARGE_INTEGER litmp = {};
	LONGLONG _tvalue[2] = {};
	mocl_fp64 returntime = 0.0, frequency = 0.0, dfm = 0.0;
public:
	void Timing_Start();
	mocl_fp64 Timing_Ended();
};
...
// ¾ØÕó¼ÆËã.
#define MOCL_TOOL_ROTATEMIRX MOCL_MirrorRotateX  // x.¾µÏñÐý×ª ( in_matrix_ImgRGB ) return in_matrix_ImgRGB
#define MOCL_TOOL_ROTATEMIRY MOCL_MirrorRotateY  // y.¾µÏñÐý×ª ( in_matrix_ImgRGB ) return in_matrix_ImgRGB
#define MOCL_TOOL_ROTATECOPY MOCL_CopyMatrixImg  // copy ( in_matrix_ImgRGB ) return in_matrix_ImgRGB [NF]

// Matrix ADD ( in_matrix_ImgRGB_a, blend_a, in_matrix_ImgRGB_b, blend_b ) 
// in_matrix_ImgRGB_a = in_matrix_ImgRGB_a * blend_a + in_matrix_ImgRGB_b * blend_a
// return matrix_ImgRGB [NF]
#define MOCL_TOOL_ADDBLEND MOCL_AddBlend
