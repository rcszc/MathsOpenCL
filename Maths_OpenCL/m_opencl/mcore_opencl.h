...
struct mocl_CLpacket {
	cl_device_id Device;           // cl设备
	cl_context Context;            // cl上下文
	cl_command_queue CommandQueue; // cl命令队列
	cl_program Program;            // cl程序
	cl_kernel Kernel;              // cl核函数

	cl_mem* MemObjects;            // cl内存对象[ptr]
...
#define MOCL_FUNC_SYSTEM  MOCL_GetSystemInfo
